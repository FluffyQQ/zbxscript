...
def send_telegram_alert(
    ...
    caption = f"""<b>Ошибка в тесте iTrans "Модуль планирования и координации"</b>\n\n<b>Шаг:</b> {step_info}\n<b>Дата:</b> {date_str}\n<b>Время:</b> {time_str}"""
...
def main() -> int:
    ...
    try:
        ...
        if not execute_step_with_retry(
            ...
            driver, test_result, telegram_token, telegram_chat_id,
            step_description="Вкладка Модуль Координатора",
        ):
            return 1
        ...
        if not execute_step_with_retry(
            ...
            driver, test_result, telegram_token, telegram_chat_id,
            step_description="Вкладка Аналитика",
        ):
            return 1
        ...
        if not execute_step_with_retry(
            ...
            driver, test_result, telegram_token, telegram_chat_id,
            step_description="Вкладка Модуль управления ресурсами",
        ):
            return 1
        ...
        if not execute_step_with_retry(
            ...
            driver, test_result, telegram_token, telegram_chat_id,
            step_description="Вкладка Регулировки",
        ):
            return 1
