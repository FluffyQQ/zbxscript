...
def run_test_cycle():
    ...
    try:
        ...
        routes = [
            ...
            {'from': 'Шушары, терминал АО Логистика-Терминал, Санкт-Петербург, Российская Федерация', 'to': 'Екатеринбург-Товарный, терминал ТК, Екатеринбург, Российская Федерация'},
            {'from': 'Хабаровск 2, терминал ТК, Хабаровск, Российская Федерация', 'to': 'Купавна, терминал ООО "Контейнерный терминал Купавна", Москва, Российская Федерация'},
            {'from': 'Угловая, подъездной путь ООО "Дальневосточная юридическая компания Авеста", Владивосток, Российская Федерация', 'to': 'Челябинск-Грузовой, терминал ТК, Челябинск, Российская Федерация'},
            {'from': 'Столбовая, подъездной путь АО АК ЖДЯ, Столбовая, Российская Федерация', 'to': 'Нижний Бестях, терминал ЖДЯ, Якутск, Российская Федерация'},
            {'from': 'Селятино, подъездной путь ООО СТС-Логистика, Москва, Российская Федерация', 'to': 'Блочная, терминал ТК, Пермь, Российская Федерация'},
            {'from': 'Селятино, подъездной путь АО "Славтранс-Сервис", Москва, Российская Федерация', 'to': 'Угольная, терминал АО "Пасифик Интермодал Контейнер", Владивосток, Российская Федерация'},
            {'from': 'Петропавловск-Камчатский, порт, Петропавловск-Камчатский, Российская Федерация', 'to': 'Ростов-Товарный, терминал ТК, Ростов-на-Дону, Российская Федерация'},
            {'from': 'Первая Речка, терминал ТК, Владивосток, Российская Федерация', 'to': 'Базаиха, терминал ТК, Красноярск, Российская Федерация'},
            {'from': 'Осенцы, подъездной путь ООО "ЛУКОЙЛ-Пермнефтеоргсинтез", Пермь, Российская Федерация', 'to': 'Ростов-Товарный, терминал ТК, Ростов-на-Дону, Российская Федерация'},
            {'from': 'Нижний Бестях, терминал ЖДЯ, Якутск, Российская Федерация', 'to': 'Петропавловск-Камчатский, порт, Петропавловск-Камчатский, Российская Федерация'},
            {'from': 'Находка (Восточный), порт, Находка, Российская Федерация', 'to': 'Челябинск-Грузовой, терминал ТК, Челябинск, Российская Федерация'},
            {'from': 'Находка (Восточный), порт, Находка, Российская Федерация', 'to': 'Селятино, подъездной путь ООО СТС-Логистика, Москва, Российская Федерация'},
            {'from': 'Находка (Восточный), порт, Находка, Российская Федерация', 'to': 'Оренбург, терминал РЖД, Оренбург, Российская Федерация'},
            {'from': 'Находка (Восточный), порт, Находка, Российская Федерация', 'to': 'Купавна, терминал ООО "Контейнерный терминал Купавна", Москва, Российская Федерация'},
            {'from': 'Находка (Восточный), порт, Находка, Российская Федерация', 'to': 'Костариха, терминал ТК, Нижний Новгород, Российская Федерация'},
            {'from': 'Находка (Восточный), порт, Находка, Российская Федерация', 'to': 'Екатеринбург-Товарный, терминал ТК, Екатеринбург, Российская Федерация'},
            {'from': 'Кресты, терминал ОАО Мосагронаучприбор, Москва, Российская Федерация', 'to': 'Магадан, порт, Магадан, Российская Федерация'},
            {'from': 'Комсомольск-на-Амуре, терминал РЖД, Комсомольск-на-Амуре, Российская Федерация', 'to': 'Санкт-Петербург-Финляндский, терминал РЖД, Санкт-Петербург, Российская Федерация'},
            {'from': 'Комсомольск-на-Амуре, терминал РЖД, Комсомольск-на-Амуре, Российская Федерация', 'to': 'Пыть-Ях, подъездной путь ООО "НТС-Лидер", Пыть-Ях, Российская Федерация'},
            {'from': 'Комсомольск-на-Амуре, терминал РЖД, Комсомольск-на-Амуре, Российская Федерация', 'to': 'Придача, терминал ТК, Воронеж, Российская Федерация'},
            {'from': 'Качалино, терминал РЖД, Волгоград, Российская Федерация', 'to': 'Клещиха, терминал ТК, Новосибирск, Российская Федерация'},
            {'from': 'Ворсино, терминал ТК, Обнинск, Российская Федерация', 'to': 'Хабаровск 2, терминал ТК, Хабаровск, Российская Федерация'},
            {'from': 'Базаиха, терминал ТК, Красноярск, Российская Федерация', 'to': 'Безымянка, терминал РЖД, Самара, Российская Федерация'},
        ]
